...
def _json_list(value: Any, field: str) -> str:
    ...
    if field == "triggered_rules":
        ...
        for item in value:
            ...
            if not isinstance(item["rule_name"], str) or not isinstance(item["evidence"], str) or not isinstance(item["triggered"], bool):
                raise ValueError("Invalid triggered_rules")
...
class InvestigationRepository:
    ...
    def save_investigation(self, values: Mapping[str, Any]) -> dict[str, Any]:
        ...
        if not isinstance(values["investigation_summary"], str) or not isinstance(values["recommended_action"], str):
        ...
        record = InvestigationModel(
            ...
            ml_fraud_probability=_finite_number(values["ml_fraud_probability"], "ML probability"),
